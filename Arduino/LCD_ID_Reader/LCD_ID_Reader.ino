...
void setup() {
  ...
  if( id == 0x7783 ) {
    ...
    lcdFillScreen(GREEN);
    lcdFillScreen(CYAN);
    lcdFillScreen(MAGENTA);
    lcdFillScreen(YELLOW);
    lcdFillScreen(WHITE);
    lcdFillScreen(BLACK);
    Serial.println("Te encontre");
  } else {
    lcdRegisterOther();
    lcdFillScreen(0xF800);
...
void lcdRegister9335() {
  lcdWriteRegister(0x01, 0x0100); // driver output control
  lcdWriteRegister(0x02, 0x0200); // set inverion
  lcdWriteRegister(0x03, 0x1030); // set entry mode
  lcdWriteRegister(0x08, 0x0202); // set back & front porch
  lcdWriteRegister(0x09, 0x0000); // set scan interval
  lcdWriteRegister(0x0a, 0x0000); // set display control1
  lcdWriteRegister(0x0c, 0x0000); // set RGB I/F display control
  lcdWriteRegister(0x0d, 0x0000); // set frame mark position
  lcdWriteRegister(0x60, 0x2700); // set gate scan control
  lcdWriteRegister(0x61, 0x0001); // Normally White
  lcdWriteRegister(0x6a, 0x0000); // set gate scan control
  delay(10); //delay 10ms
  lcdWriteRegister(0x10, 0x1490); // set BT, STB & SLP
  lcdWriteRegister(0x11, 0x0227); // set VCi1 & step up circuits
  delay(20); //delay 80ms
  lcdWriteRegister(0x12, 0x000c); // set VREGOUT1
  delay(10); //delay 50ms
  lcdWriteRegister(0x13, 0x0300); // set VCOMAC,1000,
  lcdWriteRegister(0x29, 0x0004); // set VCOMH, 000B,0004,
  lcdWriteRegister(0x2b, 0x000b); // set frame rate
  delay(10); //delay 50ms
  lcdWriteRegister(0x20, 0x0000); // set Gram horizontal address
  lcdWriteRegister(0x21, 0x0000); // set Gram vertical address
  //============Gamma============
  lcdWriteRegister(0x30, 0x0000);
  lcdWriteRegister(0x31, 0x0406);
  lcdWriteRegister(0x32, 0x0002);
  lcdWriteRegister(0x35, 0x0402);
  lcdWriteRegister(0x36, 0x0004);
  lcdWriteRegister(0x37, 0x0507);
  lcdWriteRegister(0x38, 0x0103);
  lcdWriteRegister(0x39, 0x0707);
  lcdWriteRegister(0x3c, 0x0204);
  lcdWriteRegister(0x3d, 0x0004);
  //=============================
  lcdWriteRegister(0x50, 0x0000); // set RAM address
  lcdWriteRegister(0x51, 0x00ef);
  lcdWriteRegister(0x52, 0x0000);
  lcdWriteRegister(0x53, 0x013f);
  delay(10); //delay 10ms
  lcdWriteRegister(0x07, 0x0133); // display on
